	...
	\begin{myitemize}
		...
		\item DevOps Engineer 
			...
			\begin{myitemize}
				...
				\item Consumed both enterprise APIs and generated custom datasets to pinpoint and monitor traffic through systems with complex interdependence. 

				\item Built automated systems to prevent and remediate common vulnerabilities and exposures (CVEs) from appearing on production systems.

				\item Used open source tools including nmap, wireshark, and netcat to create reports that help visualize and simplify data.
