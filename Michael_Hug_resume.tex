	...
	\begin{myitemize}
		...
		\item DevOps Engineer 
			...
			\begin{myitemize}
				...
				\item Combined APIs and custom datasets to pinpoint network / security excess privileges

				\item Prevented and remediated common vulnerabilities and exposures from production systems

				\item Generate reports from open source tools like nmap wireshark netcat
